...
class RepliesControllerTest < ActionController::TestCase
  ...
  test "should create reply" do
    assert_difference('Reply.count') do
      post :create, reply: { ba_id: @reply.ba_id, body: @reply.body, user_id: @reply.user_id }
    end
  ...
  test "should update reply" do
    patch :update, id: @reply, reply: { ba_id: @reply.ba_id, body: @reply.body, user_id: @reply.user_id }
    assert_redirected_to reply_path(assigns(:reply))
  end
